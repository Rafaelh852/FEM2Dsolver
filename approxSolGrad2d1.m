...
% Last update: Chung-min Lee April 26, 2021
...
if (lx > notri)
    ckNan = zeros(lx,1);
    for i = 1:notri
        gradpsi1 = shapeFnGrad2d(1,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),1);
        gradpsi2 = shapeFnGrad2d(2,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),1);
        gradpsi3 = shapeFnGrad2d(3,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),1);
    ...
    gradz(~ckNan,:) = nan(sum(~ckNan),2);
     ...
     for i = 1:lx
         gradpsi1 = shapeFnGrad2d(1,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),1);
         gradpsi2 = shapeFnGrad2d(2,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),1);
         gradpsi3 = shapeFnGrad2d(3,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),1);
...
if (lx > notri)
    ckNan = zeros(lx,1);
    for i = 1:notri
        gradpsi1 = shapeFnGrad2d(1,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),2);
        gradpsi2 = shapeFnGrad2d(2,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),2);
        gradpsi3 = shapeFnGrad2d(3,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),2);
        gradpsi4 = shapeFnGrad2d(4,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),2);
        gradpsi5 = shapeFnGrad2d(5,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),2);
        gradpsi6 = shapeFnGrad2d(6,x(:),y(:),nodes(N1(i),1),nodes(N1(i),2),nodes(N2(i),1),nodes(N2(i),2),nodes(N3(i),1),nodes(N3(i),2),2);
    ...
    gradz(~ckNan,:) = nan(sum(~ckNan),2);
     ...
     for i = 1:lx
         gradpsi1 = shapeFnGrad2d(1,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),2);
         gradpsi2 = shapeFnGrad2d(2,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),2);
         gradpsi3 = shapeFnGrad2d(3,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),2);
         gradpsi4 = shapeFnGrad2d(4,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),2);
         gradpsi5 = shapeFnGrad2d(5,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),2);
         gradpsi6 = shapeFnGrad2d(6,x(i),y(i),nodes(N1,1),nodes(N1,2),nodes(N2,1),nodes(N2,2),nodes(N3,1),nodes(N3,2),2);
